...
export const STRINGS = {
    ...
    'tools.draw-freeform-types.irregular-monochar.name': 'Single-Character Line',
    'tools.draw-freeform-types.irregular-monochar.description': 'Draws a line by repeating the selected character.',
    'tools.draw-freeform-types.irregular-adaptive.name': 'Autogenerated ASCII Line',
    'tools.draw-freeform-types.irregular-adaptive.description': 'Draws a smooth ASCII line. Characters are picked automatically based on how the line crosses each cell.',
    'tools.draw-rect-types.outline-ascii-1.name': 'Characters: /---\\',
    'tools.draw-rect-types.outline-ascii-1.description': 'Uses only basic ASCII characters.',
    'tools.draw-rect-types.outline-ascii-2.name': 'Characters: +---+',
    'tools.draw-rect-types.outline-ascii-2.description': 'Uses only basic ASCII characters.',
    'tools.draw-rect-types.outline-unicode-1.name': 'Characters: ┌───┐',
    'tools.draw-rect-types.outline-unicode-1.description': 'Uses Unicode characters.',
    'tools.draw-rect-types.outline-unicode-2.name': 'Characters: ╔═══╗',
    'tools.draw-rect-types.outline-unicode-2.description': 'Uses Unicode characters.',
    'tools.draw-rect-types.outline-monochar.name': 'Single-Character Outline',
    'tools.draw-rect-types.outline-monochar.description': 'Draws a rectangle outline by repeating the selected character.',
    'tools.draw-rect-types.filled-monochar.name': 'Single-Character Filled',
    'tools.draw-rect-types.filled-monochar.description': 'Draws a filled rectangle by repeating the selected character.',

    'tools.draw-line-types.straight-adaptive.name': 'Autogenerated Straight ASCII Line',
    'tools.draw-line-types.straight-adaptive.description': 'Draws a straight line using various ASCII characters to best fit the slope.',
    'tools.draw-line-types.straight-monochar.name': 'Straight Single-Character Line',
    'tools.draw-line-types.straight-monochar.description': 'Draws a straight line by repeating the selected character.',
    'tools.draw-line-types.elbow-line-ascii.name': 'Right-Angle ASCII Line',
    'tools.draw-line-types.elbow-line-ascii.description': 'Draws an ASCII line with a single right-angle bend.',
    'tools.draw-line-types.elbow-line-ascii.change-route': 'Reverse the bend direction',
    'tools.draw-line-types.elbow-arrow-ascii.name': 'Right-Angle ASCII Arrow',
    'tools.draw-line-types.elbow-arrow-ascii.description': 'Draws an ASCII line with a single right-angle bend, ending in an arrow.',
    'tools.draw-line-types.elbow-arrow-ascii.change-route': 'Reverse the bend direction',
    'tools.draw-line-types.elbow-line-unicode.name': 'Right-Angle Unicode Line',
    'tools.draw-line-types.elbow-line-unicode.description': 'Draws a Unicode line with a single right-angle bend.',
    'tools.draw-line-types.elbow-line-unicode.change-route': 'Reverse the bend direction',
    'tools.draw-line-types.elbow-arrow-unicode.name': 'Right-Angle Unicode Arrow',
    'tools.draw-line-types.elbow-arrow-unicode.description': 'Draws a Unicode line with a single right-angle bend, ending in an arrow.',
    'tools.draw-line-types.elbow-arrow-unicode.change-route': 'Reverse the bend direction',
    'tools.draw-line-types.elbow-line-monochar.name': 'Right-Angle Single-Character Line',
    'tools.draw-line-types.elbow-line-monochar.description': 'Draws a line with a single right-angle bend by repeating the selected character.',
    'tools.draw-line-types.elbow-line-monochar.change-route': 'Reverse the bend direction',

    'tools.draw-ellipse-types.outline-monochar.name': 'Ellipse Outline',
    'tools.draw-ellipse-types.outline-monochar.description': 'Draws an ellipse outline by repeating the selected character.',
