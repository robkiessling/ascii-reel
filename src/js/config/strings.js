...
export const strings = {
    ...
    'tools.standard.draw-freeform.name': 'Freeform Line',
    ...
    'tools.draw-freeform-types.current-char.description': 'Draws a line by repeating the selected character. Press any key to change the character.',
