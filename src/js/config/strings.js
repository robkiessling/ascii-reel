...
export const STRINGS = {
    ...
    'tools.shapes.freeformStroke.irregular-monochar.description': 'Draws a freeform line by repeating a single character.',
    'tools.shapes.freeformStroke.irregular-adaptive.name': 'Autogenerated ASCII Line',
    'tools.shapes.freeformStroke.irregular-adaptive.description': 'Draws a smooth line using ASCII characters based on how the line crosses each cell.',
    ...
    'tools.shapes.rectStroke.outline-monochar.description': 'Draws a rectangle outline by repeating a single character.',

    'tools.shapes.lineStroke.name': 'Line Stroke',
    'tools.shapes.lineStroke.straight-adaptive.name': 'Straight ASCII Line',
    'tools.shapes.lineStroke.straight-adaptive.description': 'Draws straight lines using best-fit ASCII characters for each slope.',
    'tools.shapes.lineStroke.straight-monochar.name': 'Straight Single-Character Line',
    'tools.shapes.lineStroke.straight-monochar.description': 'Draws straight lines by repeating a single character.',
    'tools.shapes.lineStroke.elbow-adaptive.name': 'Right-Angle ASCII Line',
    'tools.shapes.lineStroke.elbow-adaptive.description': 'Draws lines with right-angle bends using best-fit ASCII characters.',
    'tools.shapes.lineStroke.elbow-monochar.name': 'Right-Angle Single-Character Line',
    'tools.shapes.lineStroke.elbow-monochar.description': 'Draw lines with right-angle bends by repeating a single character.',
