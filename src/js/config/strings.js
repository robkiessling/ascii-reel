...
export const STRINGS = {
    ...
    'tools.draw-line-types.ascii-straight.name': 'Autogenerated Straight ASCII Line',
    'tools.draw-line-types.ascii-straight.description': 'Draws a straight line using various ASCII characters to best fit the slope.',
    'tools.draw-line-types.current-char-straight.name': 'Straight Single-Character Line',
    'tools.draw-line-types.current-char-straight.description': 'Draws a straight line by repeating the selected character.',
    'tools.draw-line-types.ascii-right-angle-line.name': 'Right-Angle Line',
    'tools.draw-line-types.ascii-right-angle-line.description': '',
    'tools.draw-line-types.ascii-right-angle-arrow.name': 'Right-Angle Arrow',
    'tools.draw-line-types.ascii-right-angle-arrow.description': '',
    'tools.draw-line-types.current-char-right-angle.name': 'Right-Angle Single-Character Line',
    'tools.draw-line-types.current-char-right-angle.description': '',
