...
export const STRINGS = {
    ...
    'tools.shapes.freeformStyle.name': 'Freeform Style',
    'tools.shapes.freeformStyle.irregular-monochar.name': 'Single-Character Line',
    'tools.shapes.freeformStyle.irregular-monochar.description': 'Draws a line by repeating the selected character.',
    'tools.shapes.freeformStyle.irregular-adaptive.name': 'Autogenerated ASCII Line',
    'tools.shapes.freeformStyle.irregular-adaptive.description': 'Draws a smooth ASCII line. Characters are picked automatically based on how the line crosses each cell.',

    'tools.shapes.rectStyle.name': 'Rectangle Style',
    'tools.shapes.rectStyle.outline-ascii-1.name': 'Characters: /---\\',
    'tools.shapes.rectStyle.outline-ascii-1.description': 'Uses only basic ASCII characters.',
    'tools.shapes.rectStyle.outline-ascii-2.name': 'Characters: +---+',
    'tools.shapes.rectStyle.outline-ascii-2.description': 'Uses only basic ASCII characters.',
    'tools.shapes.rectStyle.outline-unicode-1.name': 'Characters: ┌───┐',
    'tools.shapes.rectStyle.outline-unicode-1.description': 'Uses Unicode characters.',
    'tools.shapes.rectStyle.outline-unicode-2.name': 'Characters: ╔═══╗',
    'tools.shapes.rectStyle.outline-unicode-2.description': 'Uses Unicode characters.',
    'tools.shapes.rectStyle.outline-monochar.name': 'Single-Character Outline',
    'tools.shapes.rectStyle.outline-monochar.description': 'Draws a rectangle outline by repeating the selected character.',
    // 'tools.shapes.rectStyle.filled-monochar.name': 'Single-Character Filled',
    // 'tools.shapes.rectStyle.filled-monochar.description': 'Draws a filled rectangle by repeating the selected character.',

    'tools.shapes.lineStyle.name': 'Line Style',
    'tools.shapes.lineStyle.straight-adaptive.name': 'Autogenerated Straight ASCII Line',
    'tools.shapes.lineStyle.straight-adaptive.description': 'Draws a straight line using various ASCII characters to best fit the slope.',
    'tools.shapes.lineStyle.straight-monochar.name': 'Straight Single-Character Line',
    'tools.shapes.lineStyle.straight-monochar.description': 'Draws a straight line by repeating the selected character.',
    'tools.shapes.lineStyle.elbow-line-ascii.name': 'Right-Angle ASCII Line',
    'tools.shapes.lineStyle.elbow-line-ascii.description': 'Draws an ASCII line with a single right-angle bend.',
    'tools.shapes.lineStyle.elbow-line-ascii.change-route': 'Reverse the bend direction',
    'tools.shapes.lineStyle.elbow-arrow-ascii.name': 'Right-Angle ASCII Arrow',
    'tools.shapes.lineStyle.elbow-arrow-ascii.description': 'Draws an ASCII line with a single right-angle bend, ending in an arrow.',
    'tools.shapes.lineStyle.elbow-arrow-ascii.change-route': 'Reverse the bend direction',
    'tools.shapes.lineStyle.elbow-line-unicode.name': 'Right-Angle Unicode Line',
    'tools.shapes.lineStyle.elbow-line-unicode.description': 'Draws a Unicode line with a single right-angle bend.',
    'tools.shapes.lineStyle.elbow-line-unicode.change-route': 'Reverse the bend direction',
    'tools.shapes.lineStyle.elbow-arrow-unicode.name': 'Right-Angle Unicode Arrow',
    'tools.shapes.lineStyle.elbow-arrow-unicode.description': 'Draws a Unicode line with a single right-angle bend, ending in an arrow.',
    'tools.shapes.lineStyle.elbow-arrow-unicode.change-route': 'Reverse the bend direction',
    'tools.shapes.lineStyle.elbow-line-monochar.name': 'Right-Angle Single-Character Line',
    'tools.shapes.lineStyle.elbow-line-monochar.description': 'Draws a line with a single right-angle bend by repeating the selected character.',
    'tools.shapes.lineStyle.elbow-line-monochar.change-route': 'Reverse the bend direction',

    'tools.shapes.ellipseStyle.name': 'Ellipse Style',
    'tools.shapes.ellipseStyle.outline-monochar.name': 'Ellipse Outline',
    'tools.shapes.ellipseStyle.outline-monochar.description': 'Draws an ellipse outline by repeating the selected character.',
