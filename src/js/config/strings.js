...
export const strings = {
    ...
    'tools.standard.draw-freeform-char.description': 'Draw a freeform line using the current character. Press any key to change the character.',
    'tools.standard.fill-char.name': 'Fill Character',
    // 'tools.standard.fill-char.description': 'Fill a connected area of matching characters with the current character. Press any key to change the character.',
    ...
    'tools.standard.fill-char.description': 'Fill an area with the current character. Press any key to change the character.',
    ...
    'tools.standard.char-picker.name': 'Current Character',
    'tools.standard.char-picker.description': 'Click to open the character picker. Or press any key to change the current character to that key.',
    'tools.standard.color-picker.name': 'Current Color',
