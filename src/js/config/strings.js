...
export const STRINGS = {
    ...
    'tools.shapes.lineStroke.elbow-line-ascii-vh.name': 'Right-Angle ASCII Line',
    'tools.shapes.lineStroke.elbow-line-ascii-vh.description': 'Draws an ASCII line with a single right-angle bend. Draws the vertical component first.',
    'tools.shapes.lineStroke.elbow-line-ascii-hv.name': 'Right-Angle ASCII Line',
    'tools.shapes.lineStroke.elbow-line-ascii-hv.description': 'Draws an ASCII line with a single right-angle bend. Draws the horizontal component first.',
    'tools.shapes.lineStroke.elbow-line-unicode-vh.name': 'Right-Angle Unicode Line',
    'tools.shapes.lineStroke.elbow-line-unicode-vh.description': 'Draws a Unicode line with a single right-angle bend. Draws the vertical component first.',
    'tools.shapes.lineStroke.elbow-line-unicode-hv.name': 'Right-Angle Unicode Line',
    'tools.shapes.lineStroke.elbow-line-unicode-hv.description': 'Draws a Unicode line with a single right-angle bend. Draws the horizontal component first.',
    'tools.shapes.lineStroke.elbow-line-monochar-vh.name': 'Right-Angle Single-Character Line',
    'tools.shapes.lineStroke.elbow-line-monochar-vh.description': 'Draws a line with a single right-angle bend by repeating the selected character. Draws the vertical component first.',
    'tools.shapes.lineStroke.elbow-line-monochar-hv.name': 'Right-Angle Single-Character Line',
    'tools.shapes.lineStroke.elbow-line-monochar-hv.description': 'Draws a line with a single right-angle bend by repeating the selected character. Draws the horizontal component first.',

    // 'tools.shapes.lineStroke.elbow-line-ascii.change-route': 'Reverse the bend direction',
    // 'tools.shapes.lineStroke.elbow-arrow-ascii.name': 'Right-Angle ASCII Arrow',
    // 'tools.shapes.lineStroke.elbow-arrow-ascii.description': 'Draws an ASCII line with a single right-angle bend, ending in an arrow.',
    // 'tools.shapes.lineStroke.elbow-arrow-ascii.change-route': 'Reverse the bend direction',
    // 'tools.shapes.lineStroke.elbow-line-unicode.change-route': 'Reverse the bend direction',
    // 'tools.shapes.lineStroke.elbow-arrow-unicode.name': 'Right-Angle Unicode Arrow',
    // 'tools.shapes.lineStroke.elbow-arrow-unicode.description': 'Draws a Unicode line with a single right-angle bend, ending in an arrow.',
    // 'tools.shapes.lineStroke.elbow-arrow-unicode.change-route': 'Reverse the bend direction',
    // 'tools.shapes.lineStroke.elbow-line-monochar.change-route': 'Reverse the bend direction',
