...
export const strings = {
    ...
    'editor.tools.pan.name': 'Panning Tool',
    'editor.tools.pan.description': 'Pans the view window.',
    'editor.tools.move-all.name': 'Move All Content',
    'editor.tools.move-all.description': 'Moves all drawn cells to a new location.',
